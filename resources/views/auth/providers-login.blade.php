...
<li class="active"><a class="waves-effect" href="{{ route('providers.login') }}">Login</a></li>
<li class=""><a class="waves-effect" href="{{ route('providers.register') }}">Register</a></li>
@endsection
@section('topnavoptions')
<li class="active"><a href="{{ route('providers.login') }}">Login</a></li>
<li class=""><a href="{{ route('providers.register') }}">Register</a></li>
@endsection
@section('content')
...
<div class="container">
  ...
  <div class="row" id="login-container">
    ...
    <div class="card" id="login-form">
      ...
      <form class="row card-content" action="{{ route('providers.login.submit') }}" method="post">
        @csrf
        <p>Logging in as Provider, <a href="{{ route('consumers.login') }}" class="underlined">Change to User</a> </p>
        <br>
        ...
        <div class="col s12" id="other-action">
          ...
          <br>
          <p>Don't have an account? <a href="{{ route('providers.register') }}" class="underlined">Sign Up Instead</a></p>
        </div>
      </form>
    </div>
  </div>
